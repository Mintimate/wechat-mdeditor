    ...
    <div class="flex-1 overflow-y-auto py-10 px-4 flex justify-center bg-gradient-to-b from-gray-200/60 to-gray-300/60 dark:from-gray-900 dark:to-black">
      ...
      <div class="relative shrink-0" style="width: 375px; height: 812px;">
        ...
        <div class="w-[375px] h-[812px] rounded-[44px] bg-white dark:bg-gray-900 overflow-hidden relative
          ...
          <!-- ===== STATUS BAR ===== -->
          <div class="absolute top-0 left-0 right-0 h-[52px] z-30 flex justify-between items-start px-7 pt-[17px] select-none pointer-events-none bg-[#ededed] dark:bg-[#1c1c1e]">
            <span class="text-[15px] font-semibold text-gray-900 dark:text-white tracking-tight">9:41</span>
            ...
            <div class="flex items-center gap-[6px] mt-[2px]">
              ...
              <div class="flex items-end gap-[1.5px] h-[13px]">
                <div class="w-[4px] bg-gray-900 dark:bg-white rounded-[1.5px]" style="height:31%"></div>
                <div class="w-[4px] bg-gray-900 dark:bg-white rounded-[1.5px]" style="height:52%"></div>
                <div class="w-[4px] bg-gray-900 dark:bg-white rounded-[1.5px]" style="height:73%"></div>
                <div class="w-[4px] bg-gray-900 dark:bg-white rounded-[1.5px]" style="height:100%"></div>
              </div>
              <!-- WiFi - iPhone 15 Pro style smooth arcs -->
              <svg class="w-[18px] h-[13px] text-gray-900 dark:text-white" viewBox="0 0 26 20" fill="currentColor">
              ...
              <div class="flex items-center">
                <div class="relative w-[27px] h-[13px] border-[1.5px] border-gray-900 dark:border-white rounded-[3px] overflow-hidden">
                  <div class="absolute inset-[1.5px] bg-gray-900 dark:bg-white rounded-[2px]"></div>
                </div>
                <div class="w-[1.5px] h-[5px] bg-gray-900 dark:bg-white rounded-r-full ml-[0.5px]"></div>
              </div>
            </div>
          </div>
          ...
          <div class="absolute top-[52px] left-0 right-0 h-[44px] z-20 flex items-center justify-between px-4 bg-[#ededed] dark:bg-[#1c1c1e] border-b border-black/[0.08] dark:border-white/[0.08]">
            <!-- Back button -->
            <button class="flex items-center gap-[2px] text-[#07C160] dark:text-[#07C160]">
              <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="15 18 9 12 15 6"/>
              </svg>
            </button>
            <!-- Title -->
            <span class="text-[16px] font-medium text-gray-800 dark:text-gray-100 truncate max-w-[200px]">公众号文章</span>
            <!-- More (•••) -->
          ...
          <div
            ...
            class="absolute left-0 right-0 overflow-y-auto scrollbar-hide bg-white dark:bg-gray-900"
            style="top: 96px; bottom: 88px;"
            id="wx-box"
          >
            <div
          ...
          <div class="absolute bottom-0 left-0 right-0 z-20 bg-[#f7f7f7] dark:bg-[#1c1c1e] border-t border-black/[0.08] dark:border-white/[0.08]">
            <!-- Toolbar row -->
            <div class="flex items-center gap-2 px-3 py-2">
              <!-- Message input mock -->
              <div class="flex-1 h-9 bg-white dark:bg-gray-700 rounded-full flex items-center px-3 gap-2 border border-gray-200 dark:border-gray-600 shadow-inner">
              ...
              <a href="https://github.com/Mintimate" target="_blank" class="flex flex-col items-center">
                <svg class="w-[22px] h-[22px] text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="flex justify-center pb-[6px]">
              <div class="w-32 h-[4px] rounded-full bg-gray-800/20 dark:bg-white/20"></div>
            </div>
          </div>
